...
function small(url){
	var h = $(window).height()-400+'px';
	var w = $(window).width()-700+'px';
	$.layer({
		type: 2,
		shade: [0.5, '#888'],
		border: [0.2, 0.1, '#000'],
...
function middle(url){
	var h = $(window).height()-300+'px';
	var w = $(window).width()-500+'px';
	$.layer({
		type: 2,
		shade: [0.5, '#888'],
		border: [0.2, 0.1, '#000'],
...
function delWithMsg(url,tipMsg){
	$.layer({
		shade: [0.5, '#888'],
		border: [0.2, 0.1, '#000'],
		area: ['auto','auto'],
