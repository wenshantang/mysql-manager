...
KindEditor.plugin('music', function (K) {
    var self = this, name = 'music',
		...
		imgPath = self.pluginsPath + 'music/images/',
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			...
			'<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + target + '" action="' + K.addParam(uploadJson, 'dir=music') + '">',
			//file
			'<div class="ke-dialog-row">',
			hiddenElements.join(''),
